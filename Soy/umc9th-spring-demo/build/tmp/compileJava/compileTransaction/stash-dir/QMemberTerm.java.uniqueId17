...
public class QMemberTerm extends EntityPathBase<MemberTerm> {
    ...
    private static final long serialVersionUID = 861334652L;
    ...
    public final com.example.umc9thspringdemo.domain.member.entity.QTerm term;
    ...
    public QMemberTerm(Class<? extends MemberTerm> type, PathMetadata metadata, PathInits inits) {
        ...
        this.term = inits.isInitialized("term") ? new com.example.umc9thspringdemo.domain.member.entity.QTerm(forProperty("term")) : null;
    }
