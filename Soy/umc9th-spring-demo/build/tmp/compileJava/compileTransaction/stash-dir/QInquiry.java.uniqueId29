...
public class QInquiry extends EntityPathBase<Inquiry> {
    ...
    private static final long serialVersionUID = -508392478L;
    ...
    public final EnumPath<com.example.umc9thspringdemo.domain.inquiry.enums.InquiryType> inquiryType = createEnum("inquiryType", com.example.umc9thspringdemo.domain.inquiry.enums.InquiryType.class);
