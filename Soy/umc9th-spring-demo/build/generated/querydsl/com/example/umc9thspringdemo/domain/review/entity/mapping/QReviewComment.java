...
public class QReviewComment extends EntityPathBase<ReviewComment> {
    ...
    private static final long serialVersionUID = -1016110637L;
    ...
    public final com.example.umc9thspringdemo.domain.review.entity.QReview review;
    ...
    public QReviewComment(Class<? extends ReviewComment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new com.example.umc9thspringdemo.domain.review.entity.QReview(forProperty("review"), inits.get("review")) : null;
    }
